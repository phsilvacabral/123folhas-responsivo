    ...
    <main>
        ...
        <section id="section_conteudo">
            <div id="destinos_queroir_topo">
                ...
                <p><img src="../../img_principais/icone_jafui.png"> Já fui</p>
            </div>
            ...
            <section id="section_destinos">
                ...
                <div class="destino_individual">
                    ...
                    <div id="textos_destino_individual">
                        ...
                        <div id="div_centralizar_datas">
                            <div id="div_data_ida">
                                <p class="label_datas_valor">Data de ida:</p>
                                <p class="datas">12/34/5678</p>
                            </div>

                            <div id="div_data_volta">
                                <p class="label_datas_valor">Data de volta:</p>
                                <p class="datas">12/34/5678</p>
                            </div>                            
                        </div>

                        <div id="div_valor_gasto">
                            <p class="label_datas_valor">Valor gasto:</p>
                            <p class="valor_gasto">R$ 12.345</p>
                        </div>
        ...
        <div id="titulo_div_excluir">
            ...
            <span id="titulo_excluir">Excluir</span>
                ...
                <form action="" id="form_senha" method="get">
                    ...
                    <span id="erro_senha">Deseja mesmo apagar esse destino da lista 'Já fui'</span>
