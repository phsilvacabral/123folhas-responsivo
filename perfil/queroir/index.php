...
<body>
        ...
        <section id="section_conteudo">
            ...
            <section id="section_destinos">
                ...
                <div class="destino_individual">
                    <div id="imagem_destino"><a href="../../destino/"><img src="../../destino/imagens/destino1.jpg" alt="destino1"></a></div>

                    <div id="textos_destino_individual">
                        <p id="nome_lugar"><a href="../../destino/">Lugar que quero muito ir</a></p>
                        <p id="localizacao_lugar">Cidade, estado, pais</p>

                        <span id="your_coment">Seu comentário:</span>
                        <div id="comentario_destino"> <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit architecto  quis ullam perferendis laudantium. Lorem ipsum dolor sit amet consectetur adipisicing  elit. Fugit architecto quis ullam perferendis laudantium. pedro henrique silva cabral é lindo</p></div>

                        <img src="../../img_principais/lixeira.png" alt="apagar destino" id="lixeira_apagar">
                    </div>
                </div>


                <div class="destino_individual">
                    <div id="imagem_destino"><a href="../../destino/"><img src="../../img_destinos/destino1.jpg" alt="destino1"></a></div>
    ...
    <script>
        ...
        document.getElementById("lixeira_apagar").addEventListener("click", function() {
