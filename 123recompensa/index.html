...
<body>
        ...
        <section id="section_conteudo">
            <div id="resgate_topo">
                ...
                <div id="div_perfil_resgata">
                    ...
                    <div><span>Nome completo do usuário</span>
                    <p><span>$100</span> pontos</p></div>
                </div>
            </div>
            ...
            <section id="section_produtos">
                ...
                <div class="produto_individual">
                    <div id="imagem_produto"><img src="../destino/imagens/destino1.jpg" alt="destino1"></div>

                    <div id="textos_produto_individual">
                        <p id="nome_produto">Lugar que quero muito</p>

                        <div id="descricao_produto"> <p>Lorem ipsum dolor sit amet consectetur </p></div>
        ...
        <div id="titulo_div_resgata">
            ...
            <div id="popup-content_resgata">
                ...
                <div id="resumo_brinde">
                    ...
                    <img src="../img_principais/logo.png" id="img_brinde_resumo">
    ...
    <script>
        ...
        document.getElementById("resgatar_brinde_popup").addEventListener("click", function() {
            document.getElementById("popup_resgatar").style.display = "none";
        });


        let elementos = document.getElementsByClassName("resgatar_brinde_pagina");

        for (var i = 0; i < elementos.length; i++) {
            elementos[i].addEventListener("click", function() {
                document.getElementById("popup_resgatar").style.display = "block";
            });
        }


        document.getElementById("close_resgatar").addEventListener("click", function() {
            document.getElementById("popup_resgatar").style.display = "none";
        });
