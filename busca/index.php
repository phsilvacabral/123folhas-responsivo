...
<head>
    ...
    <title>Busca por "conteudo"</title>
</head>
        ...
        <section id="section_conteudo">
            ...
            <section id="section_buscas">
                ...
                <div class="buscado_individual">
                    <div class="imagem_buscado"><a href="../destino/"><img src="../destino/imagens/destino1.jpg" alt="blog1"></a></div>

                    <div class="textos_buscado_individual">
                        <p class="nome_lugar"><a href="../../destino/">Lugar que quero muito ir</a></p>
                        <p class="localizacao_lugar">Cidade, estado, pais</p>

                        <div class="descricao_destino"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit architecto  quis ullam perferendis laudantium. Lorem ipsum dolor sit amet consectetur adipisicing  elit. Fugit architecto quis ullam perferendis laudantium. pedro henrique silva cabral é lindo</p></div>

                        <div class="div_dificuldade_preco">
                            <div class="dificuldade_buscado">Dificuldade: <img src="../../img_principais/dificuldade.png"></div>
                            <div class="preco_buscado">R$ 1.000</div>
                        </div>
                    </div>
                </div>
